...
$id = isset($_POST['id_trabajador']) ? (int)$_POST['id_trabajador'] : 0;
...
$uploadDir = __DIR__ . '/../../../uploads/trabajadores/';
if (!is_dir($uploadDir)) @mkdir($uploadDir, 0755, true);

$dest = $uploadDir . $id . '.jpg';

// Normalizar a JPG 256x256
$src = match($mime){
...
out(true, ['path' => "uploads/trabajadores/$id.jpg"]);
